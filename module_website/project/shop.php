...
<div class="container"  ng-controller="ctrl">
  ...
  <div class="container">
   <div class="row" id="smooth">
      <div class="col-sm-2">
         <a href="#angular-shop">
        <img src="img/product2.jpg" alt="" class="icon img-responsive" data-toggle="tooltip" title="click for details">
          </a>
      ...
      <div class="col-sm-2">
       <a href="#angular-shop2">
        <img src="img/product1.jpg" alt="" class="icon img-responsive" data-toggle="tooltip" title="click for details">
         </a>
      ...
      <div class="col-sm-2">
        ...
        <img src="img/product3.jpg" alt="" class="icon img-responsive" data-toggle="tooltip" title="click for details">
        </a>
      ...
      <div class="col-sm-2">
        ...
        <img src="img/product4.jpg" alt="" class="icon img-responsive" data-toggle="tooltip" title="click for details">
        </a>
      ...
      <div class="col-sm-2">
        ...
        <img src="img/product8.jpg" alt="" class="icon img-responsive" data-toggle="tooltip" title="click for details">
      </a>
      ...
      <div class="col-sm-2">
        ...
        <img src="img/product9.jpg" id="exp-sale" alt="" class="icon img-responsive" data-toggle="tooltip" title="click for details">
      </a>
